...
//
//Да се напише програма која за секоја низа ќе го испечати процентот на огледални еднакви броеви во низата. Огледални броеви во низа се првиот
// и последниот,
// вториот и претпоследниот итн. Доколку низата има непарен број на елементи, средниот елемент е и огледален и еднаков.
//
//пример влез:
//
//3
...
int main() {
    ...
    for(int i = 0; i < n; i++) {
        ...
        double rezultat = ((double) ogledalni / m) * 100;
